...
| Informs           | `informs`    | A contributes knowledge or perspective that shapes understanding of B | Paper A informs research question Q                                 |
...
| Supplement        | `supplement` | A is supplemental material for B                                      | Dataset A accompanies and supports the methods described in paper B |
